...
from .base import *
from FlexMol.util.data.collate_func import tuple_collate

__all__ = ['Transformer']

#adapted from https://github.com/kexinhuang12345/DeepPurpose/blob/master/DeepPurpose/encoders.py

@register_collate_func(tuple_collate)
@register_to_device(True)
class Transformer(EncoderLayer):
    """
    Transformer is an encoder model using the transformer architecture.
    """

    def __init__(self, input_dim, emb_size, emb_max_pos_size, dropout_rate, n_layer, intermediate_size,
                 num_attention_heads, attention_probs_dropout, hidden_dropout_rate, device="cpu", pooling=True):
        """
        ...
        Parameters:
            ...
            emb_max_pos_size (int): Maximum position size for embeddings.
            dropout_rate (float): Dropout rate for embeddings.
            n_layer (int): Number of transformer layers.
            intermediate_size (int): Size of the intermediate layer.
            num_attention_heads (int): Number of attention heads.
            attention_probs_dropout (float): Dropout rate for attention probabilities.
            hidden_dropout_rate (float): Dropout rate for hidden layers.
        ...
        if(pooling):
            ...
            self.output_shape = (emb_max_pos_size, emb_size)
